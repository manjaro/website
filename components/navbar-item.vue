  ...
  <nav class="dark:bg-gray-900">
    ...
    >
      ...
      >
        ...
        <div
          class="menu menu-lg dropdown-content mt-1 mr-3 z-[1] p-2 pb-5 shadow bg-base-100"
        >
          <ul tabindex="0">
            <li>
              <NuxtLink
...
onMounted(() => {
  checkbox.value!.checked = colorMode.value === 'dark'
...
const getLinkStyle = (name: string) => {
  ...
  if (path[0] == name) {
    ...
    ret
      += ' relative after:absolute after:w-4/6 after:h-[2.7px] after:left-0 after:right-0 after:-bottom-1 after:mx-auto after:bg-accent-800 dark:after:bg-accent-200 after:rounded-full'
  }
  return ret
}
